...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                @php $ringkasan = \App\Models\PenilaianKinerja::hitungRingkasanNilai($laporan->detail_penilaian ?? [], $laporan->kategori ?? 'pegawai'); @endphp
                <table class="table table-bordered table-sm mb-0">
                    ...
                    <tr class="table-primary fw-bold"><th>NILAI KESELURUHAN</th><td class="text-end">{{ number_format($laporan->nilai_total ?? $ringkasan['nilai_keseluruhan'], 2, ',', '.') }}</td></tr>
                </table>
            </div>
        </div>
