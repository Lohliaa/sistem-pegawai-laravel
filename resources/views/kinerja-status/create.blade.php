...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0"><i class="bi bi-plus-circle"></i> Tambah Status Kepegawaian</h3>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('kinerja-status.store') }}" method="POST">
            @csrf
            <div class="mb-3">
                ...
                <input type="text" name="nama_status" id="nama_status" class="form-control @error('nama_status') is-invalid @enderror"
                       value="{{ old('nama_status') }}" placeholder="Contoh: PKWTT" required>
                @error('nama_status')
