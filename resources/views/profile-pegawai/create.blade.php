...
<div class="card">
    <div class="card-body">
        <form action="{{ route('profile-pegawai.store') }}" method="POST">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="user_id" id="user_id" class="form-select">
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" @selected(old('user_id') === $user->id)>{{ $user->username }} ({{ \App\Models\User::ROLES[$user->role] ?? $user->role }})</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    ...
                    <input type="text" name="tempat" id="tempat" class="form-control"
                           value="{{ old('tempat') }}" maxlength="255">
                </div>
                <div class="col-md-3">
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    ...
                    <input type="text" name="unit" id="unit" class="form-control"
                           value="{{ old('unit') }}" maxlength="255">
                </div>
                <div class="col-md-6">
                    <label for="jabatan" class="form-label">Jabatan</label>
                    <input type="text" name="jabatan" id="jabatan" class="form-control"
                           value="{{ old('jabatan') }}" maxlength="255" placeholder="Contoh: Guru, Kabid SDM">
                </div>
            </div>
