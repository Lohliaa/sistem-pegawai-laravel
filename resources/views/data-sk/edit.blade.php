...
@section('title', 'Edit Data SK')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0"><i class="bi bi-pencil"></i> Edit Data SK</h3>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('data-sk.update', $sk->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="no_sk" id="no_sk" class="form-control"
                           value="{{ old('no_sk', $sk->no_sk) }}" maxlength="255" required>
                </div>
                <div class="col-md-6">
                    ...
                    <select name="status_kepegawaian" id="status_kepegawaian" class="form-select">
                        ...
                        @foreach($statusList as $status)
                            <option value="{{ $status->nama_status }}" @selected(old('status_kepegawaian', $sk->status_kepegawaian) === $status->nama_status)>{{ $status->nama_status }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control"
                           value="{{ old('nama', $sk->nama) }}" maxlength="255" required>
                </div>
                <div class="col-md-6">
                    <label for="gelar" class="form-label">Gelar</label>
                    <input type="text" name="gelar" id="gelar" class="form-control"
                           value="{{ old('gelar', $sk->gelar) }}" maxlength="255" placeholder="S.Pd.">
                </div>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    ...
                    <textarea name="alamat" id="alamat" rows="2" class="form-control"
                              placeholder="Alamat lengkap">{{ old('alamat', $sk->alamat) }}</textarea>
                </div>
                <div class="col-md-3">
                    <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
                           value="{{ old('tempat_lahir', $sk->tempat_lahir) }}" maxlength="255">
                </div>
                <div class="col-md-3">
                    <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                    <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control"
                           value="{{ old('tanggal_lahir', $sk->tanggal_lahir?->format('d/m/Y')) }}" placeholder="dd/mm/YYYY">
                </div>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-4">
                    ...
                    <input type="text" name="unit_kerja" id="unit_kerja" class="form-control"
                           value="{{ old('unit_kerja', $sk->unit_kerja) }}" maxlength="255">
                </div>
                <div class="col-md-4">
                    <label for="jabatan" class="form-label">Jabatan</label>
                    <input type="text" name="jabatan" id="jabatan" class="form-control"
                           value="{{ old('jabatan', $sk->jabatan) }}" maxlength="255">
                </div>
                <div class="col-md-4">
                    <label for="tgl_mulai" class="form-label">Tanggal Mulai</label>
                    <input type="text" name="tgl_mulai" id="tgl_mulai" class="form-control"
                           value="{{ old('tgl_mulai', $sk->tgl_mulai?->format('d/m/Y')) }}" placeholder="dd/mm/YYYY">
                </div>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-4">
                    ...
                    <input type="text" name="gaji_pokok" id="gaji_pokok" class="form-control"
                           value="{{ old('gaji_pokok', $sk->gaji_pokok) }}" placeholder="Rp 3.000.000">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="tunjangan_jabatan" id="tunjangan_jabatan" class="form-control"
                           value="{{ old('tunjangan_jabatan', $sk->tunjangan_jabatan) }}" placeholder="Rp 500.000">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="tunjangan_transport" id="tunjangan_transport" class="form-control"
                           value="{{ old('tunjangan_transport', $sk->tunjangan_transport) }}" placeholder="Rp 300.000">
                </div>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-4">
                    ...
                    <input type="text" name="tunjangan_kinerja" id="tunjangan_kinerja" class="form-control"
                           value="{{ old('tunjangan_kinerja', $sk->tunjangan_kinerja) }}" placeholder="Rp 200.000">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="tunjangan_fungsional" id="tunjangan_fungsional" class="form-control"
                           value="{{ old('tunjangan_fungsional', $sk->tunjangan_fungsional) }}" placeholder="Rp 100.000">
                </div>
                <div class="col-md-4">
                    <label for="thp" class="form-label">THP</label>
                    <input type="text" name="thp" id="thp" class="form-control"
                           value="{{ old('thp', $sk->thp) }}" placeholder="Rp 4.400.000">
                </div>
            </div>
            ...
            <div class="mt-1">
                ...
                <input type="text" name="terbilang" id="terbilang" class="form-control"
                       value="{{ old('terbilang', $sk->terbilang) }}" maxlength="255">
            </div>
